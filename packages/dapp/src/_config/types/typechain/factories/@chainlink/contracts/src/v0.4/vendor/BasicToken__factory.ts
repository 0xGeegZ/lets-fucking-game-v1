...
import type { BasicToken, BasicTokenInterface } from '../../../../../../@chainlink/contracts/src/v0.4/vendor/BasicToken'
...
type BasicTokenConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>

const isSuperArgs = (xs: BasicTokenConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
  xs.length > 1
...
export class BasicToken__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BasicToken> {
