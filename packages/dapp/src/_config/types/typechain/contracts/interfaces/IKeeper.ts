...
export interface IKeeperInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic: 'pauseKeeper' | 'setCronUpkeep' | 'setEncodedCron' | 'unpauseKeeper',
  ): FunctionFragment

  encodeFunctionData(functionFragment: 'pauseKeeper', values?: undefined): string
  ...
  encodeFunctionData(functionFragment: 'unpauseKeeper', values?: undefined): string

  decodeFunctionResult(functionFragment: 'pauseKeeper', data: BytesLike): Result
  ...
  decodeFunctionResult(functionFragment: 'unpauseKeeper', data: BytesLike): Result
...
export interface IKeeper extends BaseContract {
  ...
  functions: {
    pauseKeeper(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>
    ...
    unpauseKeeper(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>
  }
  ...
  estimateGas: {
    pauseKeeper(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>
    ...
    unpauseKeeper(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>
  }

  populateTransaction: {
    pauseKeeper(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>
    ...
    unpauseKeeper(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>
  }
}
