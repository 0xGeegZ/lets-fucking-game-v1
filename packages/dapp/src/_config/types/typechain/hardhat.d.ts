...
declare module 'hardhat/types/runtime' {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractFactory(name: 'Cron', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.Cron__factory>
    getContractFactory(
      name: 'Ownable',
      signerOrOptions?: ethers.Signer | FactoryOptions,
    ...
    getContractAt(name: 'ERC677Token', address: string, signer?: ethers.Signer): Promise<Contracts.ERC677Token>
    ...
    getContractAt(name: 'ERC677Receiver', address: string, signer?: ethers.Signer): Promise<Contracts.ERC677Receiver>
    getContractAt(name: 'LinkToken', address: string, signer?: ethers.Signer): Promise<Contracts.LinkToken>
    ...
    getContractAt(name: 'AutomationBase', address: string, signer?: ethers.Signer): Promise<Contracts.AutomationBase>
    getContractAt(name: 'ConfirmedOwner', address: string, signer?: ethers.Signer): Promise<Contracts.ConfirmedOwner>
    getContractAt(
      name: 'ConfirmedOwnerWithProposal',
      address: string,
    ...
    getContractAt(name: 'Cron', address: string, signer?: ethers.Signer): Promise<Contracts.Cron>
    ...
    getContractAt(name: 'GameV1', address: string, signer?: ethers.Signer): Promise<Contracts.GameV1>
    getContractAt(
      name: 'CronUpkeepInterface',
      address: string,
      signer?: ethers.Signer,
    ): Promise<Contracts.CronUpkeepInterface>
    getContractAt(name: 'GameV1Interface', address: string, signer?: ethers.Signer): Promise<Contracts.GameV1Interface>
    getContractAt(name: 'IKeeper', address: string, signer?: ethers.Signer): Promise<Contracts.IKeeper>
    getContractAt(name: 'Multicall3', address: string, signer?: ethers.Signer): Promise<Contracts.Multicall3>
    getContractAt(name: 'CronUpkeep', address: string, signer?: ethers.Signer): Promise<Contracts.CronUpkeep>
