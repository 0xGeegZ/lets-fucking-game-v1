...
const ProfilePicture: React.FC = () => {
  ...
  const [userGameCreationNfts, setUserGameCreationNfts] = useState(null)
  const { selectedNft, actions } = useContext(GameCreationContext)
  ...
  if (userGameCreationNfts?.length === 0) {
    return (
      <>
    ...
    <>
      ...
      <Card mb="24px">
        <CardBody>
          ...
          <NftWrapper>
            {userGameCreationNfts?.length > 0 ? (
              userGameCreationNfts
