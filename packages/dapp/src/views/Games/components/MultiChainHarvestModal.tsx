...
import { useGameCProxyAddress } from 'views/Games/hooks/useGameCProxyAddress'
import useNonBscHarvestGame from 'views/Games/hooks/useNonBscHarvestGame'
...
const MultiChainHarvestModal: React.FC<MultiChainHarvestModalProp> = ({
  ...
  const { cProxyAddress } = useGameCProxyAddress(account, chainId)
  const { onReward } = useNonBscHarvestGame(pid, cProxyAddress)
