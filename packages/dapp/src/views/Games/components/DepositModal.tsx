...
import { useFirstTimeCrossGaming } from '../hooks/useFirstTimeCrossGaming'
...
const DepositModal: React.FC<React.PropsWithChildren<DepositModalProps>> = ({
  ...
  const { isFirstTime } = useFirstTimeCrossGaming(vaultPid)
  ...
  const crossChainWarningText = isFirstTime
    ? t('A small amount of %nativeToken% is required for the first-time setup of cross-chain CAKE gaming.', {
