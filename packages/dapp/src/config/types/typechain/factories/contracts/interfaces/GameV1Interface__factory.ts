...
import type { GameV1Interface, GameV1InterfaceInterface } from '../../../contracts/interfaces/GameV1Interface'
...
export class GameV1Interface__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): GameV1Interface {
