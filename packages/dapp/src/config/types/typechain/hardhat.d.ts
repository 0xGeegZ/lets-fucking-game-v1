...
declare module 'hardhat/types/runtime' {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractFactory(
      name: 'GameImplementationV1',
      signerOrOptions?: ethers.Signer | FactoryOptions,
    ): Promise<Contracts.GameImplementationV1__factory>
    getContractFactory(
      name: 'CronUpkeepInterface',
      signerOrOptions?: ethers.Signer | FactoryOptions,
    ): Promise<Contracts.CronUpkeepInterface__factory>
    getContractFactory(
      name: 'GameImplementationV1Interface',
      signerOrOptions?: ethers.Signer | FactoryOptions,
    ): Promise<Contracts.GameImplementationV1Interface__factory>
    getContractFactory(
      name: 'Multicall',
      signerOrOptions?: ethers.Signer | FactoryOptions,
    ...
    getContractAt(
      ...
      address: string,
      signer?: ethers.Signer,
    ): Promise<Contracts.GameImplementationV1>
    getContractAt(
      name: 'CronUpkeepInterface',
      address: string,
      signer?: ethers.Signer,
    ...
    getContractAt(
      ...
      address: string,
      signer?: ethers.Signer,
    ): Promise<Contracts.GameImplementationV1Interface>
