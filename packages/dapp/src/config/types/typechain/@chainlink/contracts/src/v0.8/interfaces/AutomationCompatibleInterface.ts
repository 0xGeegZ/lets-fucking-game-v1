...
export interface AutomationCompatibleInterfaceInterface extends utils.Interface {
  functions: {
    'checkUpkeep(bytes)': FunctionFragment
    'performUpkeep(bytes)': FunctionFragment
  }

  getFunction(nameOrSignatureOrTopic: 'checkUpkeep' | 'performUpkeep'): FunctionFragment
