...
export declare namespace GameFactory {
  ...
  export type GameStructOutput = [BigNumber, BigNumber, string, string, BigNumber] & {
    id: BigNumber
    versionId: BigNumber
    creator: string
...
export interface GameFactoryInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'games', values: [PromiseOrValue<BigNumberish>]): string
  ...
  encodeFunctionData(functionFragment: 'latestVersionId', values?: undefined): string
  ...
  encodeFunctionData(functionFragment: 'setNewGameV1', values: [PromiseOrValue<string>]): string
  ...
  decodeFunctionResult(functionFragment: 'latestVersionId', data: BytesLike): Result
  ...
  decodeFunctionResult(functionFragment: 'setNewGameV1', data: BytesLike): Result
...
export interface GameFactory extends BaseContract {
  ...
  callStatic: {
    ...
    setNewGameV1(_game: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>
  ...
  estimateGas: {
    ...
    games(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    games(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>
