...
export interface GameImplementationV1InterfaceInterface extends utils.Interface {
  functions: {
...
export interface GameImplementationV1Interface extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: GameImplementationV1InterfaceInterface
